...
<head>
    ...
    <title>LKS kab. Tegal | Login</title>
    <!-- Simple bar CSS -->
...
<body class="dark ">
    <div class="wrapper vh-100">
        <div class="row align-items-center h-100">
            ...
            <?php endif; ?>
            <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" action="<?php echo base_url() ?>Login/proses_login" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input name="username" type="text" id="text" class="form-control form-control-lg" placeholder="Username" required="" autofocus="">
                </div>
                <div class="form-group">
